...
"""SSDFeatureExtractor for EfficientNet-Edge-TPU features."""
...
class SSDEfficientNetFeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
    """SSD Feature Extractor using EfficientNet-Edge-TPU features."""
